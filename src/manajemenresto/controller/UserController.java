    ...
    public class UserController {
        ...
        public boolean updateUserById(int id, User editProfile) {
            try {
                sql = "update user set username='" + editProfile.getUsername() + "', no_telp='" + editProfile.getNoTelp()
                        + "', role='" + editProfile.getRole() + "', password='" + editProfile.getPassword()
                        + "' where id=" + id;
                int response = stm.executeUpdate(sql);
                return response > 0;
            } catch (Exception e) {
